...
const translations = {
    en: {
        ...
        'timeline.3.role3': 'Project Manager at IT Wizard (6 months & Current Working)',
        'timeline.3.role4': 'Founder and Teacher at Korean with us Korean language school (4 months & Current Working)',
    ...
    kr: {
        ...
        'timeline.3.role3': 'IT Wizard 프로젝트 매니저 (5개월 및 현재 근무 중)',
        'timeline.3.role4': 'Korean with us 한국어 학교 설립자 및 교사 (6개월 및 현재 근무 중)',
    ...
    mm: {
        ...
        'timeline.3.role3': 'IT Wizard တွင် စီမံကိန်းမန်နေဂျာ (၄ လ နှင့် လက်ရှိ အလုပ်လုပ်နေသည်)',
        'timeline.3.role4': 'Korean with us ကိုရီးယားဘာသာစကား ကျောင်း၏ တည်ထောင်သူနှင့် ဆရာ (၃ လ နှင့် လက်ရှိ အလုပ်လုပ်နေသည်)',
